...
//  RosenPortfolio
//
//  Created by Rosen, Aidan on 1/22/20.
...
char *tokenOrg(char tokenBase[1000]) { //tokenizes the word
    sizeCount = 0; 
        PHRASE in;
       memset(in.words, '\0', 1000);
       //memset(in.words.reversed, '\0', 1000);
      // memset(in.words.pigged, '\0', 1000);
      // memset(in.words.shorted, '\0', 1000);
